            ...
            {SERVICES.map((service, index) => {
              ...
              return (
                <motion.button
                  ...
                  className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/5 bg-charcoal-blue/30 p-8 text-left transition-all duration-300 hover:-translate-y-2 hover:border-gold/30 cursor-pointer w-full"
                >
                  {/* Hover glow */}
                  <div

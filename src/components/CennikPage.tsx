...
import { Check, Star, Clapperboard, Camera, ArrowRight, ArrowLeft } from "lucide-react";
          ...
          <div className="grid gap-4 sm:grid-cols-2 max-w-2xl">
            {jednorazowe.map((item, i) => (
              <motion.div
                ...
                className="flex items-center justify-between gap-4 rounded-2xl border border-white/8 bg-[#162235]/60 p-6"
              >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {fotografia.map((item, i) => (
              <motion.div
                ...
                className="flex items-center justify-between gap-4 rounded-2xl border border-white/8 bg-[#162235]/60 p-5"
              >
